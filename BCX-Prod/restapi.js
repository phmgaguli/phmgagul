...
(function() {
    ...
    class restAPI extends HTMLElement {
        ...
        renderWidget() {
            try {
                if (window.commonApp) {
                    // Your existing logic to fetch the outlineContainer
                    ...
                    if (outlineContainer && outlineContainer.getReactProps) {
                        // Fetch and subscribe to the store
                    }
                }
            } catch (e) {
                console.error("Error during connectedCallback:", e);
            }
        }
    ...
    function UI5(changedProperties, that) {
        ...
        if (that._firstConnectionUI5 === 0) {
            // XML view and rendering logic
            that._firstConnectionUI5++;
        }

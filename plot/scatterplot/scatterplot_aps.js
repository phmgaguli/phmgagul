(function () {
    ...
    class scatterPlotAps extends HTMLElement {
        constructor() {
            super();
        ...
        _submit(e) {
            e.preventDefault();
            let properties = {};
            for (let name of scatterPlotAps.observedAttributes) {
    ...
    customElements.define("com-bcx-widget-scatterplot-aps", scatterPlotAps);
})();